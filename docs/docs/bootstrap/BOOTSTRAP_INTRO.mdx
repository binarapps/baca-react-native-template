...
```bash
git clone git@github.com:binarapps/baca-react-native-template.git
cd expo-ts-template
```

> Removing git history **(not recomended)**
>
> - do it only if you don't want to keep history of commits - maybe client doesnt want this
